...
async function handleMessage(event) {
    ...
    if (message.startsWith(prefix)) {
        ...
        // Debug: Afficher les informations de l'événement pour diagnostiquer
        if (cmd === 'kick') {
            console.log('DEBUG - Event complet pour kick:', JSON.stringify({
        ...
        try {
            ...
            if (cmd === 'anime') {
                ...
                case 'expulser':
                    ...
                    console.log('DEBUG - Kick details:', {
                        mentionedUsers,
                        hasMessageReply: !!messageReply,
                        messageReplyContent: messageReply ? {
